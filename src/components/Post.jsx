      ...
      <Box flex={4} p={2}>
        <Card sx={{ margin: 5 }}>
          <CardHeader
            ...
            title="Gevalinho frontend playground with Reactjs and Material UI"
          ...
          <CardContent>
            <Typography variant="body2" color="text.secondary">
              Today I played with Material UI in reactjs. Learning frontend.
              React is such a cool javascript library. Some real fun.
            </Typography>
          </CardContent>
